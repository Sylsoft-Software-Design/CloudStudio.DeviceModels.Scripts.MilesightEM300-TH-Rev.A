...
# Parsing + Configuration Script – Milesight EM300-TH - Rev. A

This **Parsing + Configuration** script is designed for the **Milesight EM300-TH** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Milesight EM300-TH Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Milesight EM300-TH** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
